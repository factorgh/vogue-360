...
export default function HomePage() {
  useEffect(() => {
    document.title = "Vogue Vest - Exclusive Fashion & Styling";
  }, []);
        ...
        <div className="container mx-auto px-4 z-10 text-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl mb-10 max-w-2xl mx-auto font-light">
              Exclusive collections and personalized styling sessions to elevate
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            >
              Discover our latest arrivals, curated for those who appreciate
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-gray-600 mb-4">
                Founded in 2022, Vogue Vest began with a singular vision: to
                create a space where fashion transcends clothing and becomes a
                form of self-expression and empowerment.
              </p>
              <p className="text-gray-600 mb-6">
                Our team of dedicated stylists and fashion experts curate pieces
                that not only follow trends but set them. We believe in
                sustainable practices, ethical sourcing, and the power of
                fashion to transform confidence.
              </p>
              <Link
                to="/booking"
                className="btn-primary inline-flex items-center"
