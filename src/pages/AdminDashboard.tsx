              ...
              <ul>
                <li>
                  <Link
                    ...
                    className={`flex items-center px-6 py-3 text-sm ${
                      location.pathname === '/admin/dashboard' ? 'bg-gray-100 font-medium' : 'hover:bg-gray-50'
                    }`}
                  >
                ...
                <li>
                  <Link
                    ...
                    onClick={closeSidebar}
                    className={`flex items-center px-6 py-3 text-sm ${
                      location.pathname.includes('/bookings') ? 'bg-gray-100 font-medium' : 'hover:bg-gray-50'
                    }`}
                  >
                ...
                <li>
                  <Link
                    ...
                    onClick={closeSidebar}
                    className={`flex items-center px-6 py-3 text-sm ${
                      location.pathname.includes('/gallery') ? 'bg-gray-100 font-medium' : 'hover:bg-gray-50'
                    }`}
                  >
    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-white p-6 shadow-sm border rounded-sm">
          ...
          <p className="text-sm text-gray-500 mt-2">Next: Tomorrow at 10:00 AM</p>
        </div>
      </div>
        ...
        <div className="bg-white p-6 shadow-sm border rounded-sm">
          ...
          <div className="space-y-4">
            {[
              ...
              { name: 'Michael Brown', date: 'July 16, 2023', time: '11:00 AM' },
            ...
            {[
              ...
              <div key={index} className="flex items-center justify-between py-2 border-b last:border-b-0">
                <div>
                  ...
                  <p className="text-sm text-gray-500">Added on {collection.date} • {collection.items} items</p>
                </div>
                <Link 
                  to="/admin/dashboard/gallery" 
                  className="text-sm text-blue-600 hover:underline"
